...
nvcc -O2 -lineinfo -std=c++17 -arch=sm_110a -I include \
  ...
  kernels/indexer.cu kernels/compressed_attn.cu kernels/compressed_block.cu kernels/tc_moe_gemm.cu kernels/tc_fp8_gemm.cu kernels/dspark_attn.cu kernels/dspark_real.cu kernels/dspark.cu \
  -o build/forward
