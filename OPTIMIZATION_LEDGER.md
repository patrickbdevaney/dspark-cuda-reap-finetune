...
| — | next | **FP4 COMPUTE (2070 TFLOPS = Thor's strongest, 4x fp16)** — HW present but NOT in ptxas for sm_110 (CUDA 13); reach via cuBLASLt/cuDNN FP4 GEMM (library) NOW, or hand-PTX when exposed. A/B vs our TC path. | | up to ~4× | INVESTIGATE (top lever) |
